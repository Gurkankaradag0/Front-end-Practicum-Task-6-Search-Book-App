...
export default {
  ...
  theme: {
    extend: {
      ...
      dropShadow: {
        'details': '2px 6px 3px rgba(0, 0, 0, 0.4)',
      },
      keyframes: {
        flashlight: {
          '0%, 9%': {
          ...
          '10%, 15%, 85%': {opacity: 1},
          '50%': {'clip-path': 'circle(150px at 60% 20%)'},
          '54%, 100%': {'clip-path': 'circle(150px at 55% 92%)'},
          '88%, 100%': {opacity: 0}
        },
        eyes: {
          '0%, 52%': {opacity: 0},
      ...
      animation: {
        flashlight: 'flashlight 5000ms infinite',
        eyes: 'eyes 5000ms infinite'
      },
      boxShadow: {
        'img': '0 60px 40px rgb(0 0 0 / 8%)'
      }
    },
  },
  plugins: [],
